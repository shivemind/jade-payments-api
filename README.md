...
Jade Global — **core-banking** domain (AF)

## OpenAPI Spec

The canonical spec lives at [`openapi/payments-api.yaml`](openapi/payments-api.yaml).
...
```bash
docker build -t jade-payments-api:latest k8s/mock-service/
```
